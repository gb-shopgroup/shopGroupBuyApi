...
@Data
public class MemberHomeGroupActResponse {
    ...
    //滚动订单商品信息
    private List<GroupLogs> groupLogs;

    public MemberHomeGroupActResponse() {

    }

    public MemberHomeGroupActResponse(GbGroupActivityInfo data) {
    ...
    // 列表转换
    public static List<MemberHomeGroupActResponse> getGroupActResponseList(List<GbGroupActivityInfo> lists) {

        List<MemberHomeGroupActResponse> data = new ArrayList<>();
        for (GbGroupActivityInfo item : lists) {
            data.add(new MemberHomeGroupActResponse(item));
        }
        return data;
    }
